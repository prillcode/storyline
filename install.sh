...
echo "  3. /sl-story-creator .workflow/epics/epic-{id}-01.md"
echo "  4. /sl-spec-story .workflow/stories/epic-{id}-01/story-01.md"
echo "  5. /sl-develop .workflow/specs/epic-{id}-01/spec-01.md"
