...
echo "  /sl-epic-creator <PRD.md>      - Create epics from PRD/tech spec"
...
echo "  /sl-dev-story <spec-file>      - Execute technical spec (implement)"
echo ""
echo "Example workflow:"
echo "  1. /sl-epic-creator docs/PRD.md"
echo "  2. /sl-story-creator .workflow/epics/epic-001.md"
echo "  3. /sl-spec-story .workflow/stories/story-001.md"
echo "  4. /sl-dev-story .workflow/specs/spec-001.md"
echo ""
